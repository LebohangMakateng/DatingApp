...
namespace API.Data.Migrations
{
    ...
    [Migration("20220529170632_AssignmentPARTB")]
    partial class AssignmentPARTB
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.UserVisit", b =>
                {
                    b.Property<int>("SourceeUserId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("VisitedUserId")
                        .HasColumnType("INTEGER");

                    b.HasKey("SourceeUserId", "VisitedUserId");
            ...
            modelBuilder.Entity("API.Entities.UserVisit", b =>
                {
                    b.HasOne("API.Entities.AppUser", "SourceeUser")
                        .WithMany("VisitedUsers")
                        .HasForeignKey("SourceeUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
